...
const car2 = () => {
  return (
    ...
    <div className="flex flex-col  justify-center items-center max-w-[800px] bg-gray-100 space-y-4 text-blue-950">
      <h1 className="text-blue-950 text-3xl font-bold text-center  underline " >
        Honda City 2024 Price In Pakistan, Images,Reviews & Specs
      </h1>
      <Image src={"/Honda_City_Front.jpg"} width={300} height={300} alt="Alto" />
      ...
      <h1 className="text-lg text-blue-950 font-semibold">Vehicle Description</h1>
      ...
      <h1 className="text-green-400 font-bold">PKR 46.5 - 58.5 lacs</h1>
      <Link href="/login">
